...
def generate_interview_questions(
    ...
    difficulty + mode + count (+ optional single skill focus, or optional
    multi-skill list for an auto-generated mixed session). Output: a
    validated question list ready to be handed back to Express to seed a
    PracticeAttempt.
    """
    prompt = build_generate_questions_prompt(job_role, difficulty, mode, question_count, skill, skills)
