...
def generate_interview_questions(
    ...
    difficulty + mode + count. Output: a validated question list ready to be
    handed back to Express to seed a PracticeAttempt.
    """
    prompt = build_generate_questions_prompt(job_role, difficulty, mode, question_count)
