...
import { handleCreateProject } from "@/lib/actions/admin/project-action";
...
export default function ProjectForm({ jobRoles }: { jobRoles: JobRole[] }) {
    ...
    const {
        ...
        defaultValues: { isActive: true, difficulty: "Beginner" as const },
    });
        ...
        <div className="min-h-screen bg-gray-50 p-6 flex items-start justify-center">
            <div className="w-full max-w-3xl bg-white rounded-2xl shadow-md p-8">
                <div className="mb-7">
                    ...
                    <p className="text-sm text-gray-400 mt-0.5">Add a new practice project below</p>
                </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <input {...register("title")} placeholder="e.g. Karobar — Online Marketplace for Local Artisans" className={fieldClass} />
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="A concrete, real-world description of what the person will build and why"
                                rows={4}
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" {...register("estimatedHours")} placeholder="e.g. 30" className={fieldClass} />
                        ...
                        <div>
                            ...
                            <input {...register("skills")} placeholder="Comma-separated, e.g. React, Node.js, MongoDB" className={fieldClass} />
                        </div>
                        ...
                        <div>
                            ...
                            <input type="checkbox" {...register("isActive")} className="h-4 w-4 rounded border-gray-300" defaultChecked />
                        </div>
                    </div>
