...
import { handleCreateSubject } from "@/lib/actions/admin/subject-action";
    ...
    const onSubmit = (data: any) => {
        ...
        startTransition(async () => {
            try {
                ...
                const result = await handleCreateSubject(payload);
        ...
        <div className="min-h-screen bg-gray-50 p-6 flex items-start justify-center">
            <div className="w-full max-w-3xl bg-white rounded-2xl shadow-md p-8">
                <div className="mb-7">
                    ...
                    <p className="text-sm text-gray-400 mt-0.5">Add a new subject below</p>
                </div>
