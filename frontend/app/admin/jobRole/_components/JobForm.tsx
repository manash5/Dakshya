...
import { createJobRoleSchema } from "./schema";
import { handleCreateJobRole } from "@/lib/actions/admin/jobRole-action";
    ...
    const onSubmit = (data: any) => {
        ...
        startTransition(async () => {
            try {
                ...
                const result = await handleCreateJobRole(payload);
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-6 flex items-start justify-center">
            <div className="w-full max-w-3xl bg-white rounded-2xl shadow-md p-8">
                <div className="mb-7">
                    <h2 className="text-2xl font-bold text-gray-900">Create Job Role</h2>
                    <p className="text-sm text-gray-400 mt-0.5">Add a new job role below</p>
                </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="mt-8 flex gap-3">
                        ...
                        >
                            {isPending ? "Creating..." : "Create Job Role"}
                        </button>
                    </div>
                </form>
            </div>
