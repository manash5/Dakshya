        ...
        <main className="min-h-screen w-full bg-white px-6 py-8 text-neutral-900">
            <div className="mainCard mx-auto flex min-h-[calc(100vh-4rem)] w-full items-center justify-center">
                <div className="relative h-[850px] min-h-[850px] w-full max-w-[1400px] overflow-hidden rounded-[28px] bg-[#0c2422] shadow-[0_28px_75px_rgba(36,16,58,0.22)] max-lg:h-auto max-lg:min-h-0">
                    <div className="relative z-10 grid h-full grid-cols-[35%_75%] max-lg:grid-cols-1">
                            ...
                            <div className="relative z-10 flex h-full flex-col justify-between -translate-y-6 max-lg:gap-10 max-lg:translate-y-0">
                                ...
                                <div className="max-w-sm ">
                                    ...
                                    <h2 className="text-4xl font-semibold leading-tight tracking-tight">
                                        Build your <span className="text-[#b9e956]">roadmap</span>
                                    </h2>
                                    <p className="mt-4 max-w-xs text-sm text-white/70">
                                        A premium workspace that keeps your learning journey intentional, focused,
                                     ...
                                     <motion.img
                                            src="/signup.png"
                                            alt="3D illustration"
                                            className="absolute left-15 bottom-0 z-30 h-[620px] w-[860px] scale-[1.48] translate-x-[15%] object-contain drop-shadow-[0_26px_40px_rgba(0,0,0,0.3)] max-lg:static max-lg:mx-auto max-lg:h-[340px] max-lg:w-[340px] max-lg:scale-100 max-lg:translate-x-0"
                        ...
                        <section className="rightSide relative z-10 flex h-full items-center justify-center max-lg:px-6 max-lg:py-8">
                            <motion.div
                                className="relative flex h-full w-full items-center justify-center overflow-hidden rounded-[28px] bg-white px-10 py-8 shadow-[0_18px_45px_rgba(36,16,58,0.16)] max-lg:h-auto max-lg:px-6 max-lg:py-8"
